...
export async function POST(request: Request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to save nutrition record: ' + error.message }, { status: 500 });
    }
}
...
export async function PUT(request: Request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to update nutrition record: ' + error.message }, { status: 500 });
    }
}
